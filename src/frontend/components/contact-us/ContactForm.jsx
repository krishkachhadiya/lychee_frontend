            ...
            <div className="mt-6 md:mt-12 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-1 gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="pb-3 sm:pb-0 md:pb-0">
                ...
                {isSettingsLoading ? (
                  ...
                  <a href={buildMailtoHref(settings.email)} className="mt-1 inline-block text-[var(--color-text)] text-sm sm:text-base font-medium break-all hover:text-[var(--color-accent)] transition">
                    {settings.email}
                  </a>
                ) : (
