        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8">
          ...
          {activeProducts.map((product) => (
            <div
              ...
              className="group bg-[var(--color-card)] rounded-[var(--radius-lg)] overflow-hidden border border-[var(--color-border)] hover:border-[var(--color-accent)] hover:shadow-[var(--shadow-lg)] transition-all duration-300"
            >
